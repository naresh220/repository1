...
public class GenerateReport {
	...
	public static void generateReport(String projectName, String reportFolderName, String executionPlatform) {
		try {
			generateCucumberReport(projectName, reportFolderName, executionPlatform);
		} catch (Exception e) {
			System.out.println("Not able to create cucumber reports:: " + e.getMessage());
		}
	}

	public static void generateCucumberReport(String projectName, String reportFolderName, String executionPlatform)
		...
		if (executionPlatform.equalsIgnoreCase("android")) {
			...
			configuration.addClassifications("Platform Version", platformVersions);
			configuration.addClassifications("Device UDID", deviceUdids);
		} else if (executionPlatform.equalsIgnoreCase("api")) {
